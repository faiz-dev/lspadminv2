            ...
            <div class="card card-custom">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        ...
                        <button class="btn btn-primary mx-2 font-weight-bolder " data-toggle="modal"
...
@section('scripts')
    ...
    <script>
        let app = new Vue({
                    ...
                    dataTable: {
                        columns: [{
                            ...
                            },
                            {
                                ...
                                autoHide: false,
                                template: function(row, index) {
                                    return '<a href="javascript:;" data-id="' + index + '" class="btn btn-sm btn-light-primary" title="Reset">\
                                                    Jurusan\
                                                </a>\
                                            ';
                                },
            ...
            mounted() {
                let vm = this;
                this.initDataTable().then(function() {
            ...
            methods: {
                initDataTable: async function() {
                    ...
                    CDataTable.init(this.elements.dataTableSekolah, this.dataBase.daftarSekolah, this.config
                        .dataTable.columns);
                },
