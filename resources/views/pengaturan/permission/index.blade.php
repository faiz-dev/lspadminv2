            ...
            <div class="card card-custom gutter-b">
                <div class="card-header border-0">
                    <div class="card-title">
                        <h3 class="card-label">Daftar Permissions</h3>
                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        let dataJSONArray = JSON.parse('{!!  $permissions !!}');
        let category = [{
                'title': 'User',
        ...
        let columns = [{
            ...
            template: function(row) {
                let selectedCategory = category.find(c => c.slug == row.category)
                return '<span class="label font-weight-bold label-lg ' +
                    selectedCategory.class + ' label-inline">' + selectedCategory
                    .title + '</span>';
            },
        }, {
            field: 'guard_name',
    ...
    {{-- <script src="{{ asset('js/pages/crud/ktdatatable/base/data-local.js') }}"
