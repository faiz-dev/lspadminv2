    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card border-1" id="kt_form_account_wrapper">
                ...
                <div class="card-body">
                    <form class="form" action="post" novalidate="novalidate" id="kt_form_account">
                        ...
                        <div class="form-group row">
                            <label class="col-12 col-md-2">Member Type</label>
                            <div class="col-12 col-md-9">
                                <select name="tipe" id="" class="form-control">
                                    <option value="">Pilih Tipe</option>
                                    <option value="sendiri">Asesi Sendiri</option>
                                    <option value="jejaring">Asesi Jejaring</option>
                                </select>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-footer text-right">
                    ...
                    <button class="btn btn-success" id="btnSimpanAkun">Simpan Member</button>
                </div>
            </div>
