            ...
            <div class="card card-custom gutter-b">
                <div class="card-header border-0">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{route('role.create')}}" class="btn btn-sm btn-secondary mx-2 font-weight-bolder ">
                            Collapse
                        </a>
                        <!--end::Button-->
                    </div>
                ...
                <div class="card-body">
                    ...
                    <form action="">
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <div class="btn-group">
                                    <button class="btn" :class="{'btn-primary' : form.jenisAsesi == 'sendiri'}" type="button" @click="form.jenisAsesi = 'sendiri'" id="btnSiswaSendiri">Siswa Sendiri</button>
                                    <button class="btn" :class="{'btn-primary' : form.jenisAsesi == 'jejaring'}" type="button" @click="form.jenisAsesi = 'jejaring'" id="btnSiswaJejaring">Siswa Jejaring</button>
                                </div>
                            </div>                      
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <select name="tahun_daftar" id="" class="form-control" required>
                        ...
                        <div class="form-group row" v-if="form.jenisAsesi == 'jejaring'">
                            <label for="sekolah_jejaring" class="col-2 col-form-label">Sekolah Jejaring</label>
                            <div class="col-md-10">
                                <select name="sekolah_jejaring" id="" class="form-control" required>
                                    <option value="fa212d">SMK Negeri X</option>
                                    <option value="fa212d">SMK Negeri Y</option>
                                    <option value="fa212d">SMK Negeri Z</option>
                                </select>
                            </div>         
                        </div>
                    </form>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{route('role.create')}}" class="btn btn-primary mx-2 font-weight-bolder ">
                        Reload
                    </a>
                    <a href="{{route('role.create')}}" class="btn btn-primary mx-2 font-weight-bolder ">
                        Cari Asesi
