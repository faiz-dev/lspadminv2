    ...
    <div class="row" id="app">
        ...
        <div class="col-12">
            ...
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <form action="{{ route('mg-unit.update', ['mg_unit'=>$unit->uid]) }}" method="POST" id="f-tambah">
                        @csrf
                        @method("PUT")
                        <div class="form-group row">
                            <label for="kode" class="col-12 col-md-2">Kode</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="kode" value="{{ old('kode', $unit->kode) }}" placeholder="Kode Unit Kompetensi">
                                @error('kode')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="judul" value="{{ old('judul', $unit->judul) }}" placeholder="Judul Unit Kompetensi">
                                @error('judul')
                                    <span class="form-text text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="jenis_standar" value="{{ old('jenis_standar', $unit->jenis_standar) }}" placeholder="Jenis Standar">
                                @error('jenis_standar')
                                    <span class="form-text text-danger">{{$message}}</span>
                                @enderror
                            </div>
