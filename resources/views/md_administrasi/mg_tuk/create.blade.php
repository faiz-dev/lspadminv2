    ...
    <div class="row" id="app">
        ...
        <div class="col-12">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <form action="{{ route('mg-tuk.store') }}" method="POST" id="f-tambah">
                        @csrf
                        <div class="form-group row">
                            <label for="nama" class="col-12 col-md-2">Nama TUK</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="nama" value="{{ old('nama') }}" placeholder="Nama TUK">
                                @error('nama')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="telp" value="{{ old('telp') }}" placeholder="Nomor Telpon TUK">
                                @error('telp')
                                    <span class="form-text text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            <label for="jenis" class="col-12 col-md-2">Induk</label>
                            <div class="col-md-9">
                                <select name="jenis" class="form-control" id="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea name="alamat" cols="30" rows="2" class="form-control" placeholder="Alamat" maxlength="200">{{ old('alamat') }}</textarea>
                                @error('alamat')
                                    <span class="form-text text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="kota" placeholder="Kota" value="{{ old('kota') }}">
                                @error('kota')
                                    <span class="form-text text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="kode+pos" placeholder="Kode POS" value="{{ old('kode_pos') }}">
                                @error('kode_pos')
                                    <span class="form-text text-danger">{{$message}}</span>
                                @enderror
                            </div>
