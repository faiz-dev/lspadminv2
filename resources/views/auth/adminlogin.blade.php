                ...
                <div class="d-flex flex-column-fluid flex-center">
                    ...
                    <div class="login-form login-signin">
                        ...
                        <form class="form" method="post" id="kt_login_signin_form"
                            action="{{ route('admin-action-login') }}">
                            @csrf
                            <!--begin::Title-->
                            <div class="pb-13 pt-lg-0 pt-5">
                                <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Welcome to Admin
                                    Portal
                                </h3>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="text"
                                    name="username" autocomplete="off" value="a.faizmail@gmail.com" />
                            </div>
                            <!--end::Form group-->
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="password"
                                    name="password" autocomplete="off" value="root" />
                            </div>
                            <!--end::Form group-->
