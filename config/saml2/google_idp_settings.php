...
return $settings = array(
    ...
    'idp' => array(
         ...
         */
        'certFingerprint' => env('SAML2_'.$this_idp_env_id.'_IDP_x509_FINGERPRINT',''),
        'certFingerprintAlgorithm' => env('SAML2_'.$this_idp_env_id.'_IDP_x509_ALGO',''),
    ),
    ...
    'contactPerson' => array(
        'technical' => array(
            'givenName' => 'Admin SMK N 1 Kandeman',
            'emailAddress' => 'ict@smkn1kandeman.sch.id'
        ),
        'support' => array(
            'givenName' => 'Admin SMK N 1 Kandeman',
            'emailAddress' => 'ict@smkn1kandeman.sch.id'
    ...
    'organization' => array(
        'en-US' => array(
            'name' => 'smkn1kandeman',
            'displayname' => 'SMK Negeri 1 Kandeman',
            'url' => 'http://smkn1kandeman.sch.id'
        ),
    ),
